...
options = optimset('Algorithm','trust-region-reflective', 'Display', 'iter', 'GradObj','on', 'Hessian','on');
%  options = optimset('Algorithm','trust-region-reflective', 'GradObj','on', 'Hessian','on', 'TolFun', 1e-7);
fprintf('fmincon!!!');
