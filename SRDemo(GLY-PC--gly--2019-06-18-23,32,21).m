...
% load images 
list=dir(fullfile('./Data/DEM_Data_1/ROI15/','*.tif'));
for k=1:length(list)
...
tmpfile='./Data/DEM_Data_2/ROI4/ROI4_/TDM90_30_bic_ROI4.tif';
...
geotiffwrite(fullfile(roidir,'Fusion_ROI4.tif'),HR,R,'GeoKeyDirectoryTag',info.GeoTIFFTags.GeoKeyDirectoryTag);
%
